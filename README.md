...
The files present in this implementation are as follows:
CMakeLists.txt:  Information required to build the project, including the request to use the SEAL library (v3.6.6)
